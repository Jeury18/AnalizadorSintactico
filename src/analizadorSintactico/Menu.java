...
import static analizadorSintactico.Globales.LL;
import static analizadorSintactico.Globales.LU;
import static analizadorSintactico.Globales.LS;
import static analizadorSintactico.Globales.LNU;
...
int vawhile=0,vafor=0,vai=0,vasu=0;
    ...
    private void initComponents() {
        ...
        setTitle("ANALIZADOR SINTATICO");
        setBackground(new java.awt.Color(204, 204, 255));
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        areasintactico.setEditable(false);
        areasintactico.setColumns(20);
        areasintactico.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 400, 370, 130));
        ...
        tabla.setFont(new java.awt.Font("Times New Roman", 0, 11)); // NOI18N
        ...
        getContentPane().add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 220, 370, 150));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 90, 140, 50));
        jButton2.getAccessibleContext().setAccessibleName("Limpiar todo");

        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        btnlexico.setFont(new java.awt.Font("Times New Roman", 1, 11)); // NOI18N
        ...
        getContentPane().add(btnlexico, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 260, 170, 50));

        btnsintactico.setFont(new java.awt.Font("Times New Roman", 1, 11)); // NOI18N
        ...
        getContentPane().add(btnsintactico, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 460, 190, 50));
        ...
        areacadena.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, 220, 130));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel6.setText("ANALIZADOR LEXICO");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 190, -1, -1));

        jLabel8.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel8.setText("INGRESAR CADENA");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 0, 0));
        jLabel1.setText("se me hizo complicado adaptarlo a uno solo.");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 80, -1, 20));

        jLabel11.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 0, 0));
        jLabel11.setText("realizar antes el analizador lexico porque");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 60, -1, 20));

        jLabel10.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 0, 0));
        jLabel10.setText("el proceso de analizador sintactico debe de");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 40, -1, 20));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 0, 0));
        jLabel9.setText("Es bueno tener en cuenta que para realizar ");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 20, -1, 20));

        getAccessibleContext().setAccessibleName("Analizador sintactico");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ingresadosnum=0;
        ingresadospuntocoma=0;
        ingresadosigual=0;
        ingresadosletras=0;
        ingresadosint=0;ingresadosllavesabrir=0;ingresadosllavescerrar=0;
